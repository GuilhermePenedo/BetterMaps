...
export const fetchRoute = (originLng, originLat, destLng, destLat, profile = 'driving', routeType = 'normal') =>
  api.get(`/osrm/route/`, {
    params: {
      ...
      route_type: routeType // NOVO: normal, tourist, climatic, emergency
    } 
  });
